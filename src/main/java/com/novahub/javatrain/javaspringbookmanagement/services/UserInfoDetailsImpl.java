...
public class UserInfoDetailsImpl implements UserDetails {
    ...
    public UserInfoDetailsImpl(Long id, String username, String email, String password,
    ...
    public static UserInfoDetailsImpl build(User user) {
        List<GrantedAuthority> authorities = new ArrayList<>();
        Role role = user.getRole();
        authorities.add(new SimpleGrantedAuthority(role.getName()));
        return new UserInfoDetailsImpl(
                user.getId(),
                user.getEmail(),
                user.getEmail(),
                user.getPassword(),
